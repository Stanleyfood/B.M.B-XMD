...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "B.m.b-Xmd~JTNGmKxb#LN34bOMC9hJ4dDFqwQ-sz73oEsQo_9KgjKerrPrdeMs",
// add your Session Id 
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254712581738",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "✦ food✦",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ✦ food ✦*",
// add bot owner name    
...
// add alive msg here 
READ_MESSAGE: process.env.READ_MESSAGE || "yes",
